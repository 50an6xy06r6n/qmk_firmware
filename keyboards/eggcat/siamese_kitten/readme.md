...
Designed to be 3D printed on a Mini Kossel, with solderless printed hotswap sockets. Same as the Double Duck Yolk, but actually split
...
Make example for this keyboard (after setting up your build environment):
    ...
    make eggcat/siamese_kitten:default
